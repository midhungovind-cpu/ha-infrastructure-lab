...
function filesFor(host) {
  const base = {
    ...
    "/etc/fstab": "UUID=lab-root / xfs defaults 0 0\n10.10.30.10:/exports/app /srv/app nfs4 _netdev 0 0\n",
